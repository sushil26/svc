...
function sendEmail() {
  ...
  $.ajax({
    url: "https://vc4all.co/careator/pswdGenerate",
    type: "POST",
...
signaling_socket.on("connect", function () {
  ...
  signaling_socket.on("message", function (config) {
    ...
    if (config.queryId == null) {
      ...
      //document.getElementById('videoConferenceUrl').setAttribute('href', "https://vc4all.co/careator/" + peerNew_id + "/" + date);
      document
      ...
      document
        ...
        .setAttribute(
          "href",
          "https://vc4all.co/careator/" + peerNew_id + "/" + date
        );
      ...
      document
        ...
        .setAttribute(
          "href",
          "https://vc4all.co/careator/" + queryLink + "/" + date
        );
      document.getElementById("linkToShare").innerHTML =
        "https://vc4all.co/careator/" + queryLink + "/" + date;
...
function setup_local_media(callback, errorback) {
  ...
  navigator.getUserMedia(
    ...
    function (stream) {
      ...
      // $('#portfolio-wrapper').append('<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 portfolio-items"><div id="videosAttach"></div><div class="details"><button id="fullscreenbtn" class="btn fa fa-expand" style="float:left; margin-top: 10px; margin-left: 10px;"></button><h4>' + userName + '</h4> </div></div>');
