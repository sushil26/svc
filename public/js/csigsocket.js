...
function resetLoginFlag() {
  ...
  $.ajax({
    url: "https://vc4all.co/careator_reset/resetLoginFlagsById/" + id,
    type: "POST",
...
function startSession(id, date) {
  ...
  urlDate = date;
  var url = "https://vc4all.co/careator_conf/" + id + "/" + date;
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      window.location.href = "https://vc4all.co/careator_conf/" + id + "/" + date;
    },
    error: function (err) {
      console.log("err: " + JSON.stringify(err));
      console.log("err.responseText: " + JSON.stringify(err.responseText));
...
document.getElementById("scheduleVC").addEventListener("click", function () {
  ...
  window.location.href = "https://vc4all.co/careatorApp/#!/dashboard/vc4allSchedule"
...
signaling_socket.on("connect", function () {
  ...
  signaling_socket.on("message", function (config) {
    ...
    // document.getElementById("linkToShare").setAttribute("href", "https://vc4all.co/careator/" + queryLink + "/" + date);
    // document.getElementById("linkToShare").innerHTML = "https://vc4all.co/careator/" + queryLink + "/" + date;
