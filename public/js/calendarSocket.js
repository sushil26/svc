...
function vcLogout() {
    ...
    window.location = "https://vc4all.co/client";
    ...
    signaling_socket.on('connect', function () {
        ...
        signaling_socket.on('message', function (config) {
            ...
            peerNew_id = config.peer_id;
                    ...
                    document.getElementById('linkToShare').innerHTML += "https://vc4all.co/client/" + peerNew_id;
                    //document.getElementById('videoConferenceUrl').setAttribute('href', "https://vc4all.co/client/" + peerNew_id);
                    document.getElementById('linkToShare').setAttribute('href', "https://vc4all.co/client/" + peerNew_id);
