...
function saveName() {
  ...
  $.ajax({
    url: "https://vc4all.co/vc/parentCredential",
...
function emailInvite() {
  ...
  $.ajax({
    url: "https://vc4all.co/vc/emailInvite",
    //  url: "http://localhost:5000/vc/login4VC",
    type: "POST",
    data: JSON.stringify(obj),
    contentType: "application/json",
...
function momVC() {
  ...
  if (localStorage.getItem("teacherLoginId")) {
    ...
    var url = "https://vc4all.co/vc/updateEventMOM/" + eventId;
    var obj = {
      "mom": mom,
    ...
    var url = "https://vc4all.co/updateEventMOM/" + eventId;
    var obj = {
      "mom": mom,
      "momCreatedBy": "parent"
    };
...
function startSession(id, date) {
  ...
  var url = "https://vc4all.co/client/" + id + "/" + date;
  var obj = {
    "url": url
  };
  $.ajax({
...
signaling_socket.on("connect", function () {
  ...
  signaling_socket.on("message", function (config) {
    ...
    if (config.queryId == null) {
      ...
      //document.getElementById('videoConferenceUrl').setAttribute('href', "https://vc4all.co/client/" + peerNew_id + "/" + date);
      document.getElementById("videoConferenceUrl").setAttribute("onclick", "startSession('" + peerNew_id + "' , '" + date + "')");
      document.getElementById("linkToShare").setAttribute("href", "https://vc4all.co/client/" + peerNew_id + "/" + date);
      document.getElementById("linkToShare").innerHTML = "https://vc4all.co/client/" + peerNew_id + "/" + date;
    } else {
      console.log("query id nt null");

      document.getElementById("linkToShare").setAttribute("href", "https://vc4all.co/client/" + queryLink + "/" + date);
      document.getElementById("linkToShare").innerHTML = "https://vc4all.co/client/" + queryLink + "/" + date;
