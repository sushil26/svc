careatorApp.controller('profileCtrl', function ($scope, $state, careatorHttpFactory, careatorSessionAuth) {
    ...
    $scope.schoolLogoStorage = function () {
        ...
        if ($scope.myImage.resBlob) {
            ...
            var uploadURL = "https://vc4all.co/careator_comm_profileImgUpload/comm_profileImgUpload";
    ...
    $scope.profilePicUpdate = function () {
        ...
        var api = "https://vc4all.co/careator_comm_profileImgUpdateById/comm_profileImgUpdateById/" + id;
        console.log("api: " + api);
