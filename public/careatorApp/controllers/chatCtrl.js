careatorApp.controller("chatCtrl", function ($scope,$rootScope, careatorHttpFactory, careatorSessionAuth, SweetAlert) {
  ...
  $scope.getUserDataById = function () {
    ...
    var api =
      "https://vc4all.co//careator_getUser/careator_getUserById/" + id;
    console.log("api: " + api);
  ...
  $scope.getChatGroupListById = function (id) {
    ...
    var api =
      "https://vc4all.co/careator_chatGroupList/careator_getChatGroupListById/" +
      id;
    console.log("api: " + api);
    careatorHttpFactory.get(api).then(function (data) {
      console.log("data--" + JSON.stringify(data.data));
  ...
  $scope.statusUpdate = function (status) {
    ...
    var id = userData.userId;
    api = "https://vc4all.co/careator_profile/chatStatusUpdateById/" + id;
    console.log("api: " + api);
    var obj = {
      chatStatus: status
    };
  ...
  $scope.chatDetails = function (type, id, index) {
    ...
    if ($scope.selectedType == "group") {
      ...
      var group_id = id;
      var api = "https://vc4all.co/careator_groupTextRead/groupTextReadByGroupId/" + group_id;
      console.log("api: " + api);
      careatorHttpFactory.get(api).then(function (data) {
        console.log("data--" + JSON.stringify(data.data));
        var checkStatus = careatorHttpFactory.dataValidation(data);
        if (checkStatus) {
          ...
          var api = "https://vc4all.co/careator_textSeenFlagUpdate_toGroupChat/textSeenFlagUpdate_toGroupChat/" + group_id;
          console.log("*api: " + api);
          careatorHttpFactory.post(api, obj).then(function (data) {
            console.log("data--" + JSON.stringify(data.data));
            var checkStatus = careatorHttpFactory.dataValidation(data);
      ...
      var api = "https://vc4all.co/careator_getChatsById/getChatsById/" + id;
      console.log("api: " + api);
      careatorHttpFactory.get(api).then(function (data) {
        console.log("data--" + JSON.stringify(data.data));
        var checkStatus = careatorHttpFactory.dataValidation(data);
        if (checkStatus) {
          ...
          console.log("obj: " + JSON.stringify(obj));
          var api = "https://vc4all.co/careator_textSeenFlagUpdate/textSeenFlagUpdate/" + id;
          console.log("api: " + api);
          careatorHttpFactory.post(api, obj).then(function (data) {
            console.log("data--" + JSON.stringify(data.data));
            var checkStatus = careatorHttpFactory.dataValidation(data);
  ...
  $scope.chatDetailsFromNew = function (type, index) {
    ...
    if ($scope.selectedType == "group") {
      ...
      var api = "https://vc4all.co/careator_individualTextRead/individualTextReadById/" + sId + "/" + rId;
      console.log("api: " + api);
      careatorHttpFactory.get(api).then(function (data) {
        console.log("data--" + JSON.stringify(data.data));
        var checkStatus = careatorHttpFactory.dataValidation(data);
  ...
  $scope.getAllChatRightEmp = function () {
    ...
    var id = userData.userId;
    api = "https://vc4all.co/careator_getEmp/careator_getChatRightsAllemp_byLoginId/" +
  ...
  $scope.sendText = function () {
    ...
    if ($scope.selectedType == "individual_chats") {
      api = "https://vc4all.co/careator_individualText/individualText";
      console.log("api: " + api);
      console.log(
      ...
      console.log("obj: " + JSON.stringify(obj));
      api = "https://vc4all.co//careator_groupText/groupText";
      console.log("api: " + api);
      careatorHttpFactory.post(api, obj).then(function (data) {
        console.log("data--" + JSON.stringify(data.data));
        var checkStatus = careatorHttpFactory.dataValidation(data);
  ...
  $scope.readText = function () {
    ...
    if ($scope.selectedType == "group") {
      var group_id = $scope.individualData._id;
      var api =
        "https://vc4all.co/careator_groupTextRead/groupTextReadByGroupId/" +
        group_id;
      console.log("api: " + api);
      careatorHttpFactory.get(api).then(function (data) {
        console.log("data--" + JSON.stringify(data.data));
      ...
      var rId = $scope.individualData._id;
      var api =
        "https://vc4all.co/careator_individualTextRead/individualTextReadById/" +
        sId +
        "/" +
        rId;
      console.log("api: " + api);
  ...
  $scope.getChatRecords = function () {
    ...
    var id = $scope.userId;
    var api = "https://vc4all.co/careator_getChatListRecordById/getChatListRecordById/" +
      id;
    console.log("api: " + api);
    careatorHttpFactory.get(api).then(function (data) {
      // console.log("data--" + JSON.stringify(data.data));
  ...
  $scope.getGroupDetails = function (id) {
    ...
    console.log("id: " + id);
    var api =
      "https://vc4all.co/careator_getGroup/careator_getGroupById/" + id;
    console.log("api: " + api);
    careatorHttpFactory.get(api).then(function (data) {
      // console.log("data--" + JSON.stringify(data.data));
      var checkStatus = careatorHttpFactory.dataValidation(data);
