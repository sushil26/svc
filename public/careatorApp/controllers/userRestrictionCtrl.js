careatorApp.controller('userRestrictionCtrl', function ($scope, $state, $rootScope, $filter, $window, careatorHttpFactory) {
    ...
    $scope.rightEmployeeList = function () {
        ...
        var api = "https://vc4all.co/careator/getChatRights_emp";
        console.log("api: " + JSON.stringify(api));
        careatorHttpFactory.get(api).then(function (data) {
            console.log("data--" + JSON.stringify(data.data));
            var checkStatus = careatorHttpFactory.dataValidation(data);
    ...
    $scope.restrictedUserSelectEvent = {
        onItemSelect: function (item) {
            ...
            var api = "https://vc4all.co/careator_restrictedTo/restrictedTo/" + id;
            console.log("api: " + api);
            var obj = {
        ...
        onItemDeselect: function (item) {
            ...
            var api = "https://vc4all.co/careator_removeRestrictedUserById/removeRestrictedUserById/" + id;
            console.log("api: " + api);
            var obj = {
                "restrictedTo": restrictedTo
            }
    ...
    $scope.restrictUpdate = function () {
        ...
        console.log("restrictedTo: " + JSON.stringify($scope.restrictedTo));
        var api = "https://vc4all.co/careator_restrictedToSave/restrictedToSave/" + id;
        console.log("api: " + api);
        var obj = {
            "restrictedTo": restrictedTo
        }
