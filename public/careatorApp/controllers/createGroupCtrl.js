careatorApp.controller('createGroupCtrl', function ($scope, $state,careatorHttpFactory) {
    ...
    $scope.rightEmployeeList = function () {
        ...
        var api;
        // if (value == "chat") {
            api = "https://vc4all.co/careator/getChatRights_emp";
        // }
        // else if (value == "video") {
        //     api = "https://vc4all.co/careator/getVideoRights_emp";
        // }
        // else {
        //     api = "https://vc4all.co/careator/careator_getChatVideo_emp";
        // }
    ...
    $scope.creteGroup = function () {
        ...
        // if ($scope.rightSelect == 'chat') {
            api = "https://vc4all.co/careator/careator_chat_creteGroup";
        // }
        // else if ($scope.rightSelect == 'video') {
        //     api = "https://vc4all.co/careator/careator_video_creteGroup";
        // }
        // else if ($scope.rightSelect == 'both') {
        //     api = "https://vc4all.co/careator/careator_chatVideo_creteGroup";
        // }
        console.log("api: " + api);
